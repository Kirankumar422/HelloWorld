...
#
#  The program should let the player know whether to guess higher or lower, and
#  should print a message when the guess is correct. A correct guess will
...
guess = 0  # initialoze to any number outside of the valid range
while guess != answer:
    guess = int(input())
    if guess < answer:
