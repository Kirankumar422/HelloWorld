...
# of 2 smaller than the number and put 1 in that column. You then take the
# remainder and repeat the process with next highest power - putting at 1
# if it goes into remainder and a zero otherwise. Keep repeating until you
# have dealt with all powers down to 2 ** 0 (i.e., 1).
#
# Write a program that requests a number from keyboard, then prints out
